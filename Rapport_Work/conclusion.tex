...
Bien que l'application soit aujourd'hui opérationnelle et hébergée sur le serveur interne du département IT d'ABM Informatique, elle constitue un socle solide ouvrant la voie à de nombreuses évolutions structurantes pour l'avenir de COFAT :
