...
Avant de considérer le Sprint 1 comme clos, une phase de validation manuelle a été menée conjointement avec le Product Owner. Cette validation a couvert plusieurs scénarios critiques pour la suite du projet :
\begin{itemize}
...
\end{itemize}
Cette démarche de validation manuelle rigoureuse, bien que ne remplaçant pas une suite de tests automatisés exhaustive, a permis de sécuriser la livraison de ce socle avant d'y adosser l'ensemble des modules métier développés lors des sprints suivants.
