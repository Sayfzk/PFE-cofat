...
% --- Listings & Syntax Highlighting for TeXPage.com ---
\usepackage{listings}
\usepackage{xcolor}

\definecolor{codegray}{rgb}{0.96,0.96,0.96}
\definecolor{codeblue}{rgb}{0.13,0.37,0.85}
\definecolor{codepurple}{rgb}{0.58,0.0,0.82}
\definecolor{codegreen}{rgb}{0.0,0.5,0.0}

\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, catch, function, return, null, switch, var, if, in, while, do, else, case, break, const, let, async, await, require, process, module, exports},
